...
set logfile /home/cc/Documents/Abdullah/Lab_04_Data/export/Synthesis_Data/reports/lec_rtl_to_mapped.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/top_wrapper -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k /home/cc/Documents/Abdullah/Lab_04_Data/sourcecode/rtl/ALU.v /home/cc/Documents/Abdullah/Lab_04_Data/sourcecode/rtl/top_wrapper.v
elaborate_design -golden -root {top_wrapper} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/top_wrapper/fv_map.v.gz
...
#add_name_alias fv/top_wrapper/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.top_wrapper.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_wrapper.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.top_wrapper.rtl.fv_map.rpt
