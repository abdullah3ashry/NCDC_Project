...
# Generated on: Tue Aug 11 02:56:23 EDT 2026 (Tue Aug 11 06:56:23 UTC 2026)
...
set logfile /home/cc/Documents/Abdullah/Lab_04_Data/export/Synthesis_Data/reports/lec_mapped_to_opt.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/top_wrapper -golden fv_map -revised fv_opt
...
read_library -liberty -both \
    /home/cc/Documents/Abdullah/Lab_04_Data/libraries/libs/tcbn65lptc.lib \
    /home/cc/Documents/Abdullah/Lab_04_Data/libraries/libs/tpzn65lpgv2od3tc.lib \
    /home/cc/Documents/Abdullah/Lab_04_Data/libraries/libs/tcbn65lpwc.lib \
    /home/cc/Documents/Abdullah/Lab_04_Data/libraries/libs/tpzn65lpgv2od3wc.lib

read_design -verilog95   -golden -lastmod -noelab fv/top_wrapper/fv_map.v.gz
elaborate_design -golden -root {top_wrapper}

read_design -verilog95   -revised -lastmod -noelab /home/cc/Documents/Abdullah/Lab_04_Data/export/Synthesis_Data/netlists/top_wrapper_physical_synth.v
elaborate_design -revised -root {top_wrapper}

#add_name_alias fv/top_wrapper/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/top_wrapper/fv_opt.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.top_wrapper.fv_map.fv_opt.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.top_wrapper.fv_map.fv_opt.rpt
}
report_test_vector -noneq > noneq.test_vector.top_wrapper.fv_map.fv_opt.rpt
