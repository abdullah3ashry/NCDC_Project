...
# Comparing
#-------------------------------------------------------------------------------
# MODULE counter (G) INSTANCE / (G)
# MODULE counter (R) INSTANCE / (R)
# Primitive count:  (G) = 10  (R) = 15
...
# RESOLVED Constraints
# OUT (G) count[3] (REP)  =   (R) count[3] (REP) (by name)
# OUT (G) count[2] (REP)  =   (R) count[2] (REP) (by name)
# OUT (G) count[1] (REP)  =   (R) count[1] (REP) (by name)
# OUT (G) count[0] (REP)  =   (R) count[0] (REP) (by name)
set_root_module counter -Golden
