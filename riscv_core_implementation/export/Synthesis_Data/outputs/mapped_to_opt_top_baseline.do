...
# Generated on: Mon Aug 03 05:07:01 EDT 2026 (Mon Aug 03 09:07:01 UTC 2026)
...
set logfile /home/cc/Documents/Abdullah/RISCV_synthesis/export/Synthesis_Data/reports/lec_mapped_to_opt.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/riscv_top -golden fv_map -revised fv_opt
...
read_design -verilog95   -golden -lastmod -noelab fv/riscv_top/fv_map.v.gz
elaborate_design -golden -root {riscv_top}

read_design -verilog95   -revised -lastmod -noelab /home/cc/Documents/Abdullah/RISCV_synthesis/export/Synthesis_Data/netlists/riscv_top_physical_synth.v
elaborate_design -revised -root {riscv_top}

#add_name_alias fv/riscv_top/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/riscv_top/fv_opt.singlebit.original_name.alias.json.gz -revised
...
write_compared_points noneq.compared_points.riscv_top.fv_map.fv_opt.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.riscv_top.fv_map.fv_opt.rpt
}
report_test_vector -noneq > noneq.test_vector.riscv_top.fv_map.fv_opt.rpt
